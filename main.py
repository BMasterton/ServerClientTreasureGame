        ...
        with socket(AF_INET, SOCK_STREAM) as sock:  # TCP socket
            ...
            while True:
                ...
                with sc:
                    ...
                    elif first_four_only == playerDirectionDecimals[4]: # when Q is received run send the scores of 1 and then 2 as shorts, send gameboard then itll run the quit command
                    ...
                    elif first_four_only == playerDirectionDecimals[5]: # when G is hit, print the scores, print the board, and then transmit the board
                        newBoard.printScore()
                        display(newBoard)
                        sc.sendall(str(newBoard).encode())
